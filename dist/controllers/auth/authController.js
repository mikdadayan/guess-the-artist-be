...
var signup = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _b.sent();
                token = jsonwebtoken_1.default.sign({ id: newUser._id }, JWT_SECRET, {
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, existingUser, isPasswordCorrect, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
            ...
            case 2:
                ...
                token = jsonwebtoken_1.default.sign({ id: existingUser._id }, JWT_SECRET, {
                    expiresIn: TOKEN_EXPIRATION_TIME,
                });
